...
def write_odd_numbers_to_file(odd_numbers):
    with open('D:\\11_Nguyen_Minh_Hieu_0136\\KHDL_K17A3_LAB\\lab11\\ODD.txt', 'w') as file:
        for i in range(4):
            for j in range(4):
...
def print_last_line_of_odd_file():
    with open('D:\\11_Nguyen_Minh_Hieu_0136\\KHDL_K17A3_LAB\\lab11\\ODD.txt', 'r') as file:
        lines = file.readlines()
        print('Nội dung dòng cuối của file ODD.txt:')
        print(lines[-1].strip())

def main():
    content = read_file('D:\\11_Nguyen_Minh_Hieu_0136\\KHDL_K17A3_LAB\\lab11\\input.txt')
